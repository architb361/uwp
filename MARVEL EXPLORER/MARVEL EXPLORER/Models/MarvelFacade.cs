...
namespace MARVEL_EXPLORER.Models
{
    public class MarvelFacade
    {
        private const string PrivateKey = "f0cd4063d3304075489b56811c5303c0b7dbb141";
        private const string PublicKey = "2a4711ce5ddb86f052365ee7cdbd6f18";
